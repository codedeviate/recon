...
```sh
cargo build --release                                          # default-feature build
cargo build --release --features impersonate                   # the only feature variant
cargo test  --release                | tail -3                 # default suite
cargo test  --release --features impersonate --test impersonate_it | tail -3  # feature-gated
