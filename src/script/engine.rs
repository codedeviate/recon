...
pub fn build_engine(defaults: &ScriptDefaults) -> rhai::Engine {
    ...
    super::bindings::ai::register(&mut engine, defaults.verbose);
    ...
    super::bindings::jq::register(&mut engine);
    ...
    super::bindings::gh::register(&mut engine);
    ...
    super::bindings::tui::register(&mut engine);
