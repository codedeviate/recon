...
static TOPIC_DOCS: Topic = Topic {
    ...
    flags: &[
        ...
        FlagHelp { flags: "--font <NAME>", description: "Body text font for typst. Default serif (Libertinus\nSerif); bundled sans is \"IBM Plex Sans\". Code stays\nmonospace. Errors on --pdf-engine chrome." },
        FlagHelp { flags: "--font-path <DIR>", description: "Add a font directory for typst (repeatable) so --font\ncan resolve user/system fonts. Errors on chrome." },
    ...
    examples: &[
        ...
        ExampleHelp { description: "Sans-serif body font (typst; code stays monospace)", command: "recon --md-to-pdf book.md --font 'IBM Plex Sans' -o book.pdf" },
        ExampleHelp { description: "Use a system font via --font-path (typst)", command: "recon --md-to-pdf book.md --font-path ~/Library/Fonts --font 'Helvetica Neue' -o book.pdf" },
